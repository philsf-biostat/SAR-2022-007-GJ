...
dv <- "(q29 -- How satisfied are you with the Telework program in your agency?)"
iv <- "(q58 -- Managers promote communication among different work units (for example, about projects, goals, needed resources))"
```
...
This means thatthere is a detectable association between leadership commitment and
telework satisfaction.
<!-- employee development. -->
...
This translates to a 2-fold increase in the group of interest when compared to the reference group.
...
In order to control for a possible interaction between sex
...
1. Leadership commitment is associated with an increase of `r format.pct(or_o[1] -1, 0)` in employee satisfaction.
2. There is **no** effect modification by sex in the association.
