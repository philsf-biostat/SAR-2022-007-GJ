...
- OR overall: OR: 3.39, 95% CI: [2.93, 3.91]
- OR males: OR: 3.43, 95% CI: [2.89, 4.06]
- OR females: OR: 3.29, 95% CI: [2.49, 4.33]

Interpretation:

1. Leadership commitment is associated with an increase of 239% in employee satisfaction.
